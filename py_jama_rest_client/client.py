...
class JamaClient:
    ...
    def get_baselines(
        self, project_id, allowed_results_per_page=__allowed_results_per_page
    ):
        """
    ...
    def get_baselines_versioneditems(
        self, baseline_id, allowed_results_per_page=__allowed_results_per_page
    ):
        """
    ...
    def get_item_tags(
        self, item_id, allowed_results_per_page=__allowed_results_per_page
    ):
        """
    ...
    def get_abstract_items_from_doc_key(
        self, doc_key_list, allowed_results_per_page=__allowed_results_per_page
    ):
    ...
    def get_pick_list_options(
        self, pick_list_id, allowed_results_per_page=__allowed_results_per_page
    ):
        """
    ...
    def get_testruns(
        self, test_cycle_id, allowed_results_per_page=__allowed_results_per_page
    ):
    ...
    def get_tagged_items(
        self, tag_id, allowed_results_per_page=__allowed_results_per_page
    ):
        """
    ...
    def get_test_plan(self, test_plan_id: int):
        """
        This method will return JSON data about the test plan specified by the test plan id.

        Args:
            test_plan_id: the api id of the test plan to fetch

        Returns: a dictionary object that represents the test plan

        """
        resource_path = "testplans/" + str(test_plan_id)
        try:
            response = self.__core.get(resource_path)
        except CoreException as err:
            py_jama_rest_client_logger.error(err)
    ...
    def get_test_plan_cycles(self, test_plan_id: int) -> List[dict]:
        """
        This method will return JSON data about the test cycles associated to the specified test plan id.
    ...
    def get_test_run(self, test_run_id: int) -> dict:
        """
        This method will return JSON data about the test run specified by the test run id.

        Args:
            test_run_id: the api id of the test run to fetch

        Returns: a dictionary object that represents the test run
